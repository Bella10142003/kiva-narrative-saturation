...
- ~~提案 PDF 未归档进本项目~~ **已解决（2026-09-01）**：原件在 [`2_提案/5 GUYS 提案.pdf`](../2_提案/5%20GUYS%20提案.pdf)，SHA-256 `682480268af5db3de10a5dd661ea743e569b1d4b9a3c674c9241b478a6afcce4`。
  > 公开仓库里的这份已移除封面学号，SHA-256 因此变为 `bc4b42df1e03db816e9d3a7f19d236b29d5048b64a448c738010f48396a9ac90`；上面那个是**当时提交的原件**的哈希，原件本身仅本地留存（`2_提案/_原件（含学号·不入库）/`，实测 `682480268af5db3d…`）。
